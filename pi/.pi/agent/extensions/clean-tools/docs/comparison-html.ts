...
.frame{display:flex;gap:30px;padding:52px;background:linear-gradient(135deg,#6d5efc,#c86dd7 48%,#ff7eb3);font-family:"JetBrainsMono Nerd Font Mono","JetBrains Mono","SF Mono",monospace}
