...
.frame{display:flex;gap:24px;padding:48px;background:linear-gradient(135deg,#6d5efc,#c86dd7 48%,#ff7eb3);font-family:"JetBrainsMono Nerd Font Mono","JetBrains Mono",monospace}
...
pre{margin:0;padding:10px 0;font:20px/1.6 "JetBrainsMono Nerd Font Mono","JetBrains Mono",monospace;white-space:pre}
